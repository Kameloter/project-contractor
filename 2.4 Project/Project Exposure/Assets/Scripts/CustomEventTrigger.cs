...
public class CustomEventTrigger : MonoBehaviour {
    ...
    [SerializeField]
    public enum Action {
        PlaySound, PlayAnimation, PlayCameraPath, ActivateInteractable, DeactivateInteractable, ShowHint, PlayParticle, StopParticle, FocusOnTarget, ActivateLight, DisableLight, ChangeLightValues, ChangeImageEffects, ActivateObject, DeactivateObject, ChangeCameraOffset
    };
